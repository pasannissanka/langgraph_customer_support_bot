...
from agents.book_excursion_agent.agent import book_excursion_runnable, book_excursion_safe_tools
from agents.flight_booking_agent.agent import update_flight_runnable, update_flight_safe_tools
from agents.primary_agent.agent import assistant_runnable, primary_assistant_tools, ToFlightBookingAssistant, \
    ToBookExcursion
...
def pop_dialog_state(state: State) -> dict:
    ...
    if state["messages"][-1].tool_calls:
        ...
        messages.append(
            ToolMessage(
                content="Resuming dialog with the host assistant. Please reflect on the past conversation and assist "
                        "the user as needed.",
